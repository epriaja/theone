...
export function ReportForm({ report, onSubmit, onCancel }) {
  ...
  if (!currentUser || !["TU", "Admin", "Coordinator"].includes(currentUser.role)) {
    return (
        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Hanya TU, Admin, dan Coordinator yang dapat membuat atau mengedit laporan.
            </p>
            <p className="text-sm text-gray-500 mb-6">
              Role Anda saat ini: <span className="font-medium">{currentUser?.role || "Tidak diketahui"}</span>
            </p>
            <button
              onClick={onCancel}
